...
public class NumberUtils {
  ...
  public static BigDecimal parseBigDecimal(String number) {
    try {
      ...
      e.printStackTrace();
      logger.error("parseBigDecimal param :[{}] ERROR !" , number );
      for (int c : number.toCharArray()) {
        logger.error("parseBigDecimal param:[{}] ERROR !" , c );
      }
      throw e;
    }
  }
  ...
  public static String floatFormatHB(Object str) {
    ...
    if (str != null) {
      if (str.getClass().getSimpleName().equals("Double") || str.getClass().getSimpleName().equals("Integer") || str.getClass().getSimpleName().equals("BigDecimal")
   ...
   * @author hz
   */
  public static String formatNumber(Number decimal, int fraction, String nullIf) {
  ...
  public static String formatNumber(Number number, int maximumFractionDigits, int minimumFractionDigits) {
    return formatNumber(number, maximumFractionDigits, minimumFractionDigits, "0");
  }
   ...
   * @author hz
   */
  public static String formatNumber(Number number, int maximumFractionDigits, int minimumFractionDigits, String nullIf) {
    if (number == null) {
      return nullIf;
    }
